...
////////////////////////RX///////////////////////////////////
    ...
    // Configure RX PIPE#1
    static const uint8_t nRF24_ADDR_1[] = { 0xE6, 0x1B, 0xE2 };
...
////////////////////////RX///////////////////////////////////
    ...
    while (1) {
    	...
    	// Print a payload
//    	UART_SendStr("PAYLOAD:>");
//    	UART_SendBufHex((char *)nRF24_payload_tx, payload_length);
//    	UART_SendStr("< ... TX: ");

    	// Transmit a packet
    	tx_res = nRF24_TransmitPacket(nRF24_payload_tx, payload_length);
    	switch (tx_res) {
			case nRF24_TX_SUCCESS:
				UART_SendStr("OK");
				break;
